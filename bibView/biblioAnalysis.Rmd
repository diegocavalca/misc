---
title: "Resultados da Analise Bibliométrica"
...
Abaixo seguem os dados e indicadores obtidos, bem como o workflow básico para a realização de uma análise bibliométrica utilizando o R e o pacote Bibliometrix a partir dos dados de publicações científicas obtidas na base de dados [Scopus](http://www.scopus.com). 
...
```{r}
#print(params)
D <- readLines(params$dataPath)#readLines(inFile$datapath)
